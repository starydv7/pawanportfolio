...
const DotGroup=({selectedPage,setSelectedPage})=>{
    ...
    before:h-6 before:rounded-full before:border-2 before:border-yellow before:left-[-50%]
    `
    return (
        <div className="flex flex-col gap-6 fixed top-[60%] right-7">
         ...
         />
           <AnchorLink 
         className={`${selectedPage==='testnomials'?"selectedStyles":"bg-dark-grey"}
         w-3 h-3 rounded-full`}
         href="#home"
         onClick={()=>setSelectedPage('testnomials')}
         />
           <AnchorLink 
